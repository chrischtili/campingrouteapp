...
export const FAMOUS_TRAILS: Trail[] = [
  {
    ...
    highlights: ["Mummelsee", "Feldberg-Gipfel (1.493m)", "Titisee", "Saiger Höhe", "Belchen"],
  ...
  },
  {
    ...
    highlights: ["Burg Eltz", "Bremmer Calmont (steilster Weinberg Europas)", "Cochem", "Bernkastel-Kues", "Porta Nigra Trier"],
  ...
  },
  {
    ...
    highlights: ["Loreley-Felsen", "Drachenfels Siebengebirge", "Marksburg", "Pfalzgrafenstein", "Schloss Biebrich"],
  ...
  },
  {
    ...
    highlights: ["Basteibrücke", "Festung Königstein", "Schrammsteine", "Kuhstall", "Kirnitzschtal"],
  ...
  },
  {
    ...
    highlights: ["Zwölf Apostel Felsen", "Donaudurchbruch Weltenburg", "Burg Prunn", "Befreiungshalle Kelheim"],
  ...
  },
  {
    ...
    highlights: ["Blumeninsel Mainau", "Pfahlbauten Unteruhldingen", "Altstadt Lindau", "Rheinfall Schaffhausen", "Meersburg"],
  ...
  },
  {
    ...
    highlights: ["Wilseder Berg (169m)", "Totengrund", "Pietzmoor", "Heidedörfer Undeloh & Wilsede"],
  ...
  },
  {
    ...
    highlights: ["Ulmer Münster", "Kloster Weltenburg", "UNESCO-Altstadt Regensburg", "Walhalla", "Passau"],
    image_url: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Quer über den Harz und hinauf auf den sagenumwobenen Brocken. Urige Nadelwälder, Moore des Oberharzer Wasserregals und das spektakuläre Bodetal (Grand Canyon des Harzes).",
    highlights: ["Brockengipfel (1.141m)", "Bodetal-Schlucht", "Oderteich", "Dammgraben", "Rübeland-Höhlen"],
    image_url: "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    highlights: ["Nationalpark Jasmund (Kreidefelsen)", "Halbinsel Fischland-Darß-Zingst", "Hansestadt Wismar & Stralsund", "Seebad Warnemünde", "Usedom"],
    image_url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    highlights: ["Hohes Venn", "Rursee", "Vulkanmaare Daun", "Gerolsteiner Dolomiten", "Genovevahöhle"],
    image_url: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Wandertrilogie Allgäu (Himmelstürmer & Wasserläufer)",
    type: "hiking",
    region: "Allgäu",
    country: "DE",
    distance_km: 358,
    ...
    highlights: ["Breitachklamm", "Nebelhorn", "Schloss Neuschwanstein", "Großer Alpsee", "Forggensee"],
    image_url: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80",
...
export function getNearbyTrails(lat: number, lon: number, maxDistanceKm: number = 40): (Trail & { distance_to_place_km: number })[] {
