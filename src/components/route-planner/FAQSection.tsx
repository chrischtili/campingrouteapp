...
const faqs = [
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>Der KI-Prompt-Generator für maßgeschneiderte Wohnmobil-Routen!</strong></p>
        ...
        <div className="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Prompt-Generierung für volle Kontrolle oder direkte KI-Generierung (mit deinem API-Schlüssel) für sofortige Ergebnisse!</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>Zwei Wege zu deinem KI-Prompt:</strong></p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>Aktuell unterstützen wir:</strong></p>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Gib im Routenplaner deine Fahrzeugdaten ein (Länge, Höhe, Gewicht), damit wir die perfekten Stellplätze für dich finden!</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>Einfache Schritte zu deinem perfekten KI-Prompt:</strong></p>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Wir sind kein Routenplaner, sondern ein Prompt-Generator. Die eigentliche Routenplanung erfolgt durch deine KI (ChatGPT, Gemini, etc.) basierend auf unserem optimierten Prompt.</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div className="space-y-4">
        <p className="text-xs md:text-sm"><strong>✅ Ja, die Grundfunktionen sind komplett kostenlos!</strong></p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-green-50 dark:bg-green-900 p-4 rounded-lg">
            <h4 className="font-semibold mb-3 flex items-center gap-2 text-xs md:text-sm">
              <span>🆓</span> Kostenlos
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg">
          ...
          <p className="text-xs md:text-sm">Keine Abonnements, keine versteckten Gebühren - du zahlst nur, wenn du die optionale KI-Generierung nutzt (ca. 5-10 Cent pro Route).</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>🔒 100% Datenschutz - 100% lokal!</strong></p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <h4 className="font-semibold mb-3 flex items-center gap-2 text-xs md:text-sm">
        ...
        <div className="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Alle deine Daten bleiben ausschließlich auf deinem Gerät. Wir speichern nichts, analysieren nichts und geben nichts weiter. Deine Privatsphäre steht an erster Stelle!</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>✅ Ja, komplett offline-fähig!</strong></p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <h4 className="font-semibold mb-3 flex items-center gap-2 text-xs md:text-sm">
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Lade deine Routen vor der Reise herunter und habe sie auch ohne Mobilfunkempfang immer griffbereit!</p>
        </div>
      </div>
    ),
  },
  {
    ...
    a: (
      <div>
        <p className="mb-4 text-xs md:text-sm"><strong>Die Wahl hängt von deinen Prioritäten ab:</strong></p>
        ...
        <div className="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mt-4">
          ...
          <p className="text-xs md:text-sm">Für die meisten Nutzer ist <strong>Google Gemini</strong> die beste Wahl dank exzellenter geografischer Daten und präziser Stellplatz-Empfehlungen für Europa.</p>
        </div>
      </div>
    ),
  },
