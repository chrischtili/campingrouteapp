            ...
            <div className="flex items-center gap-4 text-sm text-gray-600">
              ...
              <a href="https://github.com/chrischtili/route-planner-pro" target="_blank" 
                ...
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 0C4.477 0 0 4.484 0 10.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.031-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0110 4.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.203 2.398.1 2.651.64.7 1.03 1.595 1.03 2.688 0 3.848-2.338 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.563 2.383-1.353 3.167-.66.657-1.574 1.047-2.573 1.047-.988 0-1.893-.382-2.594-1.033-.68-.634-1.037-1.573-1.037-2.648 0-.82.345-1.561.858-2.143-.062-.202-.293-.642.071-1.285.474-.79.605-1.402.605-1.732 0-.399-.202-.643-.69-.931.599-.34.973-.914.973-1.688 0-.977-.523-1.784-1.36-2.271-.72-.417-1.638-.66-2.642-.66-.902 0-1.73 .22-2.395.618C.78 1.626.26 2.503.26 3.5c0 .998.52 1.818 1.29 2.328A9.927 9.927 0 0010 10.017c5.523 0 10-4.484 10-10.017S15.523 0 10 0z" clipRule="evenodd" />
                </svg>
