                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="flex flex-col text-xs font-bold text-white">
                                <span>{formData.startDate ? new Date(formData.startDate).toLocaleDateString(i18n.language === 'de' ? 'de-DE' : i18n.language === 'nl' ? 'nl-NL' : i18n.language === 'fr' ? 'fr-FR' : 'en-US') : '?'} —</span>
                                <span>{formData.endDate ? new Date(formData.endDate).toLocaleDateString(i18n.language === 'de' ? 'de-DE' : i18n.language === 'nl' ? 'nl-NL' : i18n.language === 'fr' ? 'fr-FR' : 'en-US') : '?'}</span>
                              </div>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
