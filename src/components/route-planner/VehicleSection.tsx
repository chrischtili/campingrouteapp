...
export function VehicleSection({ formData, onChange }: VehicleSectionProps) {
  ...
  const inputClass = "w-full h-11 sm:h-12 px-4 sm:px-5 rounded-xl sm:rounded-2xl bg-white/5 border-2 border-white/10 backdrop-blur-md shadow-inner focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all outline-none font-bold text-sm sm:text-base text-white placeholder:text-white/20 placeholder:font-normal text-left";
    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        ...
        <motion.div 
          ...
          className={`p-5 sm:p-7 shadow-xl space-y-7 flex flex-col items-start text-left ${isMotorcycleTent ? "opacity-40 pointer-events-none" : ""}`}
        ...
        <motion.div 
          ...
          className="p-5 sm:p-7 shadow-lg space-y-7 flex flex-col items-start text-left" 
          style={glassPanelStyle}
        >
          <div className="flex items-center gap-3">
        ...
        <motion.div 
          ...
          className={`p-5 sm:p-7 shadow-lg space-y-7 flex flex-col items-start text-left ${isMotorcycleTent ? "opacity-40 pointer-events-none" : ""}`}
          style={glassPanelStyle}
        >
          <div className="flex items-center gap-3">
