    ...
    camping: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Ja. Wenn du deinen Zielort gefunden hast, kannst du im nächsten Schritt direkt in den Prompt-Generator wechseln.",
        },
      ],
      plannerTitle: "Nächster Schritt",
      plannerLead:
        "Wenn dein Zielort steht, geht es direkt weiter zum Prompt-Generator. Dort bereitest du deine Anfrage für Etappen, Fahrzeugdaten und Route in wenigen Klicks vor.",
    ...
    stopover: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Wenn dein Halt feststeht, kannst du direkt in den Prompt-Generator wechseln und dort deine weitere Reise vorbereiten.",
        },
      ],
      plannerTitle: "Nächster Schritt",
      plannerLead:
        "Sobald dein Halt steht, geht es direkt weiter zum Prompt-Generator. Dort formulierst du deine Touranfrage mit Fahrzeug, Etappen und Reisedaten.",
      plannerCta: "Zum Prompt-Generator",
    ...
    camping: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Oui. Une fois ta destination trouvée, tu peux passer directement au générateur de prompts.",
        },
      ],
      plannerTitle: "Étape suivante",
      plannerLead:
        "Une fois ta destination définie, tu peux passer directement au générateur de prompts pour préparer ta demande avec étapes, véhicule et détails du voyage.",
    ...
    stopover: {
      ...
      faqs: [
        ...
        },
        {
          question: "Et après ?",
          answer:
            "Quand ton arrêt est choisi, tu peux passer directement au générateur de prompts.",
        },
      ],
      plannerTitle: "Étape suivante",
      plannerLead:
        "Quand ton arrêt est défini, tu peux passer directement au générateur de prompts pour préparer ta demande avec véhicule, étapes et dates.",
      plannerCta: "Vers le générateur de prompts",
  ...
  nl: {
    camping: {
      ...
      faqs: [
        ...
        { question: "Kan ik daarna meteen verder?", answer: "Ja. Als je bestemming vaststaat, kun je direct doorgaan naar de promptgenerator." },
      ],
      plannerTitle: "Volgende stap",
      plannerLead: "Als je bestemming vaststaat, ga je direct verder naar de promptgenerator. Daar bereid je je aanvraag met etappes, voertuig en reisdetails voor.",
    ...
    stopover: {
      ...
      faqs: [
        ...
        { question: "Hoe ga ik daarna verder?", answer: "Als je stop vaststaat, kun je direct doorgaan naar de promptgenerator." },
      ],
      plannerTitle: "Volgende stap",
      plannerLead: "Zodra je stop vaststaat, ga je direct verder naar de promptgenerator. Daar formuleer je je reisaanvraag met voertuig, etappes en data.",
      plannerCta: "Naar de promptgenerator",
  ...
  it: {
    camping: {
      ...
      faqs: [
        ...
        { question: "Posso continuare subito dopo?", answer: "Sì. Quando la destinazione è chiara, puoi passare direttamente al generatore di prompt." },
      ],
      plannerTitle: "Passo successivo",
      plannerLead: "Quando la destinazione è chiara, passi direttamente al generatore di prompt. Lì prepari la tua richiesta con tappe, veicolo e dettagli di viaggio.",
    ...
    stopover: {
      ...
      faqs: [
        ...
        { question: "Come continuo dopo?", answer: "Quando la sosta è definita, puoi passare direttamente al generatore di prompt." },
      ],
      plannerTitle: "Passo successivo",
      plannerLead: "Quando la sosta è definita, passi direttamente al generatore di prompt. Lì prepari la tua richiesta con veicolo, tappe e date.",
      plannerCta: "Vai al generatore di prompt",
