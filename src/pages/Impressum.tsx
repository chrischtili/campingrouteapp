        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            <div className="text-center space-y-4 mb-16">
              ...
              <h1 className="text-4xl md:text-6xl font-black tracking-tighter">{t("imprint.title")}</h1>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <section className="legal-card p-10 rounded-[3rem] border-2 backdrop-blur-md shadow-2xl">
                ...
                <p className="text-foreground/68 dark:text-white/65 leading-relaxed text-base sm:text-lg italic font-serif">
                  {i18n.language === 'de' ? (
                    <>
                    ...
                    <>
                      Camping Route è un <a href="https://github.com/chrischtili/campingrouteapp" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline decoration-primary/30 underline-offset-4">progetto open‑source</a> privato e non commerciale per pianificare itinerari in camper con l’IA. Il sito è destinato esclusivamente a scopi informativi e dimostrativi.
                    </>
                  ) : (
                    <>
              ...
              <section className="legal-card p-10 rounded-[3rem] border-2 backdrop-blur-md shadow-2xl">
                ...
                <div className="space-y-4 text-foreground/62 dark:text-white/60 leading-relaxed">
              ...
              <section className="p-10 rounded-[3rem] border-2 border-primary/20 bg-primary/8 dark:bg-primary/5 shadow-2xl">
                ...
                <p className="text-foreground/72 dark:text-white/70 mb-8 leading-relaxed">
